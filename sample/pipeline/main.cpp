...
int main() {
  ...
  if (!(channel_1.open() && channel_2.open() && channel_3.open())) { return -1; }
  if (!(channel_2.subscribe(channel_1) && channel_3.subscribe(channel_1))) { return -1; }

  gps_1.setPeriod(std::chrono::microseconds(100000));    // 100 msec
  pos_1.setPeriod(std::chrono::microseconds(100000));    // 100 msec
  pos_2.setPeriod(std::chrono::microseconds(100000));    // 100 msec
